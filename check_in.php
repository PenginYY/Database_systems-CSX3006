          ...
          <tbody class="res-tbody">
            <tr class="res-tr">
              ...
              <td class="res-td" style="text-align: center;">
                <a href="#popup-add" class="reservation-button-red">Select</a>
              </td>
            </tr>
          </tbody>
        </table>
